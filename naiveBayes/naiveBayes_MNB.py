...
#	mnb = BernoulliNB(alpha=0.1) 
	...
	bnb.fit(Xtrain.values[0:10000], yt.values[0:10000])
	ytp =  bnb.predict(Xtrain.values[10000:,:])

	print [(yt[10000+i],ytp[i])  for i in xrange(len(ytp))]	
	acc = (1 - (1. / len(ytp) * sum( yt[10000:] != ytp )))
